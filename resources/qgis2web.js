...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 28, minZoom: 13
    })
});

// Locked layer – always visible
lyr_Brndby.setZIndex(9999);
lyr_Brndby.setVisible(true);
lyr_Brndby.set('title', '');
map.addLayer(lyr_Brndby);

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit(
    [1371283.780044, 7474827.538327, 1398783.840192, 7496433.313354],
    { size: map.getSize(), padding: [300, 300, 300, 300] }
);
