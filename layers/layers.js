...
var format_Strandvold_7 = new ol.format.GeoJSON();
var features_Strandvold_7 = format_Strandvold_7.readFeatures(json_Strandvold, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Strandvold = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Strandvold.addFeatures(features_Strandvold_7);
var lyr_Strandvold = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Strandvold, 
                style: style_Strandvold_7,
                popuplayertitle: 'Strandvold',
                interactive: true,
                title: '<img src="styles/legend/Strandvold.png" /> Strandvold'
            });
var format_Marinflade_8 = new ol.format.GeoJSON();
var features_Marinflade_8 = format_Marinflade_8.readFeatures(json_Marinflade, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Marinflade = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Marinflade.addFeatures(features_Marinflade_8);
var lyr_Marinflade = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Marinflade, 
                style: style_Marinflade_8,
                popuplayertitle: 'Marin flade',
                interactive: true,
                title: '<img src="styles/legend/Marinflade.png" /> Marin flade'
            });
var format_Bundmorneflade_9 = new ol.format.GeoJSON();
var features_Bundmorneflade_9 = format_Bundmorneflade_9.readFeatures(json_Bundmorneflade, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Bundmorneflade = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Bundmorneflade.addFeatures(features_Bundmorneflade_9);
var lyr_Bundmorneflade = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Bundmorneflade, 
                style: style_Bundmorneflade_9,
                popuplayertitle: 'Bundmoræneflade',
                interactive: true,
                title: '<img src="styles/legend/Bundmorneflade.png" /> Bundmoræneflade'
            });
var format_TerrnnrtgrundvandsommermiddelmunderterrnHIP_10 = new ol.format.GeoJSON();
var features_TerrnnrtgrundvandsommermiddelmunderterrnHIP_10 = format_TerrnnrtgrundvandsommermiddelmunderterrnHIP_10.readFeatures(json_TerrnnrtgrundvandsommermiddelmunderterrnHIP, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TerrnnrtgrundvandsommermiddelmunderterrnHIP = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TerrnnrtgrundvandsommermiddelmunderterrnHIP.addFeatures(features_TerrnnrtgrundvandsommermiddelmunderterrnHIP_10);
var lyr_TerrnnrtgrundvandsommermiddelmunderterrnHIP = new ol.layer.Vector({
                ...
                style: style_TerrnnrtgrundvandsommermiddelmunderterrnHIP_10,
    ...
    <img src="styles/legend/TerrnnrtgrundvandsommermiddelmunderterrnHIP_10_0.png" /> 0-1 m<br />\
    <img src="styles/legend/TerrnnrtgrundvandsommermiddelmunderterrnHIP_10_1.png" /> 1-2 m<br />\
    <img src="styles/legend/TerrnnrtgrundvandsommermiddelmunderterrnHIP_10_2.png" /> 2-3 m<br />\
    <img src="styles/legend/TerrnnrtgrundvandsommermiddelmunderterrnHIP_10_3.png" /> 3-7 m<br />' });
var format_TerrnnrtgrundvandvintermiddelmunderterrnHIP_11 = new ol.format.GeoJSON();
var features_TerrnnrtgrundvandvintermiddelmunderterrnHIP_11 = format_TerrnnrtgrundvandvintermiddelmunderterrnHIP_11.readFeatures(json_TerrnnrtgrundvandvintermiddelmunderterrnHIP, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TerrnnrtgrundvandvintermiddelmunderterrnHIP = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TerrnnrtgrundvandvintermiddelmunderterrnHIP.addFeatures(features_TerrnnrtgrundvandvintermiddelmunderterrnHIP_11);
var lyr_TerrnnrtgrundvandvintermiddelmunderterrnHIP = new ol.layer.Vector({
                ...
                style: style_TerrnnrtgrundvandvintermiddelmunderterrnHIP_11,
    ...
    <img src="styles/legend/TerrnnrtgrundvandvintermiddelmunderterrnHIP_11_0.png" /> 0-1 m<br />\
    <img src="styles/legend/TerrnnrtgrundvandvintermiddelmunderterrnHIP_11_1.png" /> 1-2 m<br />\
    <img src="styles/legend/TerrnnrtgrundvandvintermiddelmunderterrnHIP_11_2.png" /> 2-3 m<br />\
    <img src="styles/legend/TerrnnrtgrundvandvintermiddelmunderterrnHIP_11_3.png" /> 3-7 m<br />' });
var format_RisikoforstningsskaderGEO_12 = new ol.format.GeoJSON();
var features_RisikoforstningsskaderGEO_12 = format_RisikoforstningsskaderGEO_12.readFeatures(json_RisikoforstningsskaderGEO, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RisikoforstningsskaderGEO = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RisikoforstningsskaderGEO.addFeatures(features_RisikoforstningsskaderGEO_12);
var lyr_RisikoforstningsskaderGEO = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RisikoforstningsskaderGEO, 
                style: style_RisikoforstningsskaderGEO_12,
                popuplayertitle: 'Risiko for sætningsskader (GEO)',
                interactive: true,
    title: 'Risiko for sætningsskader (GEO)<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_12_0.png" /> 0-0,01<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_12_1.png" /> 0,01-0,02<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_12_2.png" /> 0,02-0,05<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_12_3.png" /> 0,05-0,1<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_12_4.png" /> >0,1<br />' });
var format_RisikoforoversvmmelseKystdirektoratet_13 = new ol.format.GeoJSON();
var features_RisikoforoversvmmelseKystdirektoratet_13 = format_RisikoforoversvmmelseKystdirektoratet_13.readFeatures(json_RisikoforoversvmmelseKystdirektoratet, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RisikoforoversvmmelseKystdirektoratet = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RisikoforoversvmmelseKystdirektoratet.addFeatures(features_RisikoforoversvmmelseKystdirektoratet_13);
var lyr_RisikoforoversvmmelseKystdirektoratet = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RisikoforoversvmmelseKystdirektoratet, 
                style: style_RisikoforoversvmmelseKystdirektoratet_13,
...
var format_Risikoforhavvandsindsivning_14 = new ol.format.GeoJSON();
var features_Risikoforhavvandsindsivning_14 = format_Risikoforhavvandsindsivning_14.readFeatures(json_Risikoforhavvandsindsivning, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Risikoforhavvandsindsivning = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Risikoforhavvandsindsivning.addFeatures(features_Risikoforhavvandsindsivning_14);
var lyr_Risikoforhavvandsindsivning = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Risikoforhavvandsindsivning, 
                style: style_Risikoforhavvandsindsivning_14,
                popuplayertitle: 'Risiko for havvandsindsivning',
                interactive: true,
    title: 'Risiko for havvandsindsivning<br />\
    <img src="styles/legend/Risikoforhavvandsindsivning_14_0.png" /> <br />' });
var format_Boringerdybdeim_15 = new ol.format.GeoJSON();
var features_Boringerdybdeim_15 = format_Boringerdybdeim_15.readFeatures(json_Boringerdybdeim, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Boringerdybdeim = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Boringerdybdeim.addFeatures(features_Boringerdybdeim_15);
var lyr_Boringerdybdeim = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Boringerdybdeim, 
                style: style_Boringerdybdeim_15,
                popuplayertitle: 'Boringer (dybde i m)',
                interactive: true,
    title: 'Boringer (dybde i m)<br />\
    <img src="styles/legend/Boringerdybdeim_15_0.png" /> 0 m - 0 m<br />\
    <img src="styles/legend/Boringerdybdeim_15_1.png" /> 0 m - 6 m<br />\
    <img src="styles/legend/Boringerdybdeim_15_2.png" /> 6 m - 12 m<br />\
    <img src="styles/legend/Boringerdybdeim_15_3.png" /> 12 m - 18 m<br />\
    <img src="styles/legend/Boringerdybdeim_15_4.png" /> 18 m+<br />' });
...
jsonSource_Vandlb100mbuffer.addFeatures(features_Vandlb100mbuffer_17);
var lyr_Vandlb100mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vandlb100mbuffer, 
                style: style_Vandlb100mbuffer_17,
                popuplayertitle: 'Vandløb 100m buffer',
                interactive: true,
                title: '<img src="styles/legend/Vandlb100mbuffer.png" /> Vandløb 100m buffer'
            });
var format_Vandlb20mbuffer_18 = new ol.format.GeoJSON();
var features_Vandlb20mbuffer_18 = format_Vandlb20mbuffer_18.readFeatures(json_Vandlb20mbuffer, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Vandlb20mbuffer = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Vandlb20mbuffer.addFeatures(features_Vandlb20mbuffer_18);
var lyr_Vandlb20mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vandlb20mbuffer, 
                style: style_Vandlb20mbuffer_18,
                popuplayertitle: 'Vandløb 20m buffer',
                interactive: true,
                title: '<img src="styles/legend/Vandlb20mbuffer.png" /> Vandløb 20m buffer'
            });
var format_Vandlb10mbuffer_19 = new ol.format.GeoJSON();
var features_Vandlb10mbuffer_19 = format_Vandlb10mbuffer_19.readFeatures(json_Vandlb10mbuffer, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Vandlb10mbuffer = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Vandlb10mbuffer.addFeatures(features_Vandlb10mbuffer_19);
var lyr_Vandlb10mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vandlb10mbuffer, 
                style: style_Vandlb10mbuffer_19,
                popuplayertitle: 'Vandløb 10m buffer',
                interactive: true,
                title: '<img src="styles/legend/Vandlb10mbuffer.png" /> Vandløb 10m buffer'
            });
var format_Vandlb2mbuffer_20 = new ol.format.GeoJSON();
var features_Vandlb2mbuffer_20 = format_Vandlb2mbuffer_20.readFeatures(json_Vandlb2mbuffer, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Vandlb2mbuffer = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Vandlb2mbuffer.addFeatures(features_Vandlb2mbuffer_20);
var lyr_Vandlb2mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vandlb2mbuffer, 
                style: style_Vandlb2mbuffer_20,
                popuplayertitle: 'Vandløb 2m buffer',
                interactive: true,
                title: '<img src="styles/legend/Vandlb2mbuffer.png" /> Vandløb 2m buffer'
            });
var format_Vandlb_21 = new ol.format.GeoJSON();
var features_Vandlb_21 = format_Vandlb_21.readFeatures(json_Vandlb, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Vandlb = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Vandlb.addFeatures(features_Vandlb_21);
var lyr_Vandlb = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vandlb, 
                style: style_Vandlb_21,
                popuplayertitle: 'Vandløb',
                interactive: true,
                title: '<img src="styles/legend/Vandlb.png" /> Vandløb'
            });
var format_Ser100mbuffer_22 = new ol.format.GeoJSON();
var features_Ser100mbuffer_22 = format_Ser100mbuffer_22.readFeatures(json_Ser100mbuffer, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ser100mbuffer = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ser100mbuffer.addFeatures(features_Ser100mbuffer_22);
var lyr_Ser100mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ser100mbuffer, 
                style: style_Ser100mbuffer_22,
                popuplayertitle: 'Søer 100m buffer',
                interactive: true,
                title: '<img src="styles/legend/Ser100mbuffer.png" /> Søer 100m buffer'
            });
var format_Ser20mbuffer_23 = new ol.format.GeoJSON();
var features_Ser20mbuffer_23 = format_Ser20mbuffer_23.readFeatures(json_Ser20mbuffer, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ser20mbuffer = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ser20mbuffer.addFeatures(features_Ser20mbuffer_23);
var lyr_Ser20mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ser20mbuffer, 
                style: style_Ser20mbuffer_23,
                popuplayertitle: 'Søer 20m buffer',
                interactive: true,
                title: '<img src="styles/legend/Ser20mbuffer.png" /> Søer 20m buffer'
            });
var format_Ser10mbuffer_24 = new ol.format.GeoJSON();
var features_Ser10mbuffer_24 = format_Ser10mbuffer_24.readFeatures(json_Ser10mbuffer, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ser10mbuffer = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ser10mbuffer.addFeatures(features_Ser10mbuffer_24);
var lyr_Ser10mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ser10mbuffer, 
                style: style_Ser10mbuffer_24,
                popuplayertitle: 'Søer 10m buffer',
                interactive: true,
                title: '<img src="styles/legend/Ser10mbuffer.png" /> Søer 10m buffer'
            });
var format_Ser2mbuffer_25 = new ol.format.GeoJSON();
var features_Ser2mbuffer_25 = format_Ser2mbuffer_25.readFeatures(json_Ser2mbuffer, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ser2mbuffer = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ser2mbuffer.addFeatures(features_Ser2mbuffer_25);
var lyr_Ser2mbuffer = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ser2mbuffer, 
                style: style_Ser2mbuffer_25,
                popuplayertitle: 'Søer 2m buffer',
                interactive: true,
                title: '<img src="styles/legend/Ser2mbuffer.png" /> Søer 2m buffer'
            });
var format_Ser_26 = new ol.format.GeoJSON();
var features_Ser_26 = format_Ser_26.readFeatures(json_Ser, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ser = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ser.addFeatures(features_Ser_26);
...
var format_Jordforureningvidenniveau2V2_27 = new ol.format.GeoJSON();
var features_Jordforureningvidenniveau2V2_27 = format_Jordforureningvidenniveau2V2_27.readFeatures(json_Jordforureningvidenniveau2V2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jordforureningvidenniveau2V2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jordforureningvidenniveau2V2.addFeatures(features_Jordforureningvidenniveau2V2_27);
var lyr_Jordforureningvidenniveau2V2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jordforureningvidenniveau2V2, 
                style: style_Jordforureningvidenniveau2V2_27,
...
var format_Jordforureningvidenniveau1V1_28 = new ol.format.GeoJSON();
var features_Jordforureningvidenniveau1V1_28 = format_Jordforureningvidenniveau1V1_28.readFeatures(json_Jordforureningvidenniveau1V1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jordforureningvidenniveau1V1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jordforureningvidenniveau1V1.addFeatures(features_Jordforureningvidenniveau1V1_28);
var lyr_Jordforureningvidenniveau1V1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jordforureningvidenniveau1V1, 
                style: style_Jordforureningvidenniveau1V1_28,
...
var format_Frededeomrder_29 = new ol.format.GeoJSON();
var features_Frededeomrder_29 = format_Frededeomrder_29.readFeatures(json_Frededeomrder, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Frededeomrder = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Frededeomrder.addFeatures(features_Frededeomrder_29);
var lyr_Frededeomrder = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Frededeomrder, 
                style: style_Frededeomrder_29,
                popuplayertitle: 'Fredede områder',
                interactive: true,
                title: '<img src="styles/legend/Frededeomrder.png" /> Fredede områder'
            });
var format_EngeogMoser18701899_30 = new ol.format.GeoJSON();
var features_EngeogMoser18701899_30 = format_EngeogMoser18701899_30.readFeatures(json_EngeogMoser18701899, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EngeogMoser18701899 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EngeogMoser18701899.addFeatures(features_EngeogMoser18701899_30);
var lyr_EngeogMoser18701899 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EngeogMoser18701899, 
                style: style_EngeogMoser18701899_30,
                popuplayertitle: 'Enge og Moser (1870-1899)',
                interactive: true,
                title: '<img src="styles/legend/EngeogMoser18701899.png" /> Enge og Moser (1870-1899)'
            });
var format_Gammelkystlinje18701899_31 = new ol.format.GeoJSON();
var features_Gammelkystlinje18701899_31 = format_Gammelkystlinje18701899_31.readFeatures(json_Gammelkystlinje18701899, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Gammelkystlinje18701899 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Gammelkystlinje18701899.addFeatures(features_Gammelkystlinje18701899_31);
var lyr_Gammelkystlinje18701899 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Gammelkystlinje18701899, 
                style: style_Gammelkystlinje18701899_31,
...
var format_Spildevandskloakeret_32 = new ol.format.GeoJSON();
var features_Spildevandskloakeret_32 = format_Spildevandskloakeret_32.readFeatures(json_Spildevandskloakeret, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Spildevandskloakeret = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Spildevandskloakeret.addFeatures(features_Spildevandskloakeret_32);
var lyr_Spildevandskloakeret = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Spildevandskloakeret, 
                style: style_Spildevandskloakeret_32,
                popuplayertitle: 'Spildevandskloakeret',
                interactive: true,
                title: '<img src="styles/legend/Spildevandskloakeret.png" /> Spildevandskloakeret'
            });
var format_Ingenkloakering_33 = new ol.format.GeoJSON();
var features_Ingenkloakering_33 = format_Ingenkloakering_33.readFeatures(json_Ingenkloakering, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ingenkloakering = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ingenkloakering.addFeatures(features_Ingenkloakering_33);
var lyr_Ingenkloakering = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ingenkloakering, 
                style: style_Ingenkloakering_33,
                popuplayertitle: 'Ingen kloakering',
                interactive: true,
                title: '<img src="styles/legend/Ingenkloakering.png" /> Ingen kloakering'
            });
var format_Brndby_34 = new ol.format.GeoJSON();
var features_Brndby_34 = format_Brndby_34.readFeatures(json_Brndby, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Brndby = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Brndby.addFeatures(features_Brndby_34);
var lyr_Brndby = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Brndby, 
                style: style_Brndby_34,
                popuplayertitle: 'Brøndby',
                interactive: true,
                title: '<img src="styles/legend/Brndby.png" /> Brøndby'
            });
...
lyr_ESRIGraylight_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_PlanfladeSpildevand.setVisible(false);lyr_ProjektfladeSpildevand.setVisible(false);lyr_ProjektfladeVand.setVisible(false);lyr_Antropogentlandskab.setVisible(false);lyr_S.setVisible(false);lyr_Strandvold.setVisible(false);lyr_Marinflade.setVisible(false);lyr_Bundmorneflade.setVisible(false);lyr_TerrnnrtgrundvandsommermiddelmunderterrnHIP.setVisible(false);lyr_TerrnnrtgrundvandvintermiddelmunderterrnHIP.setVisible(false);lyr_RisikoforstningsskaderGEO.setVisible(false);lyr_RisikoforoversvmmelseKystdirektoratet.setVisible(false);lyr_Risikoforhavvandsindsivning.setVisible(false);lyr_Boringerdybdeim.setVisible(false);lyr_IndledendeskadesberegningerGennemsnitligskadesomkostningerfrtiltagDKKr_16.setVisible(true);lyr_Vandlb100mbuffer.setVisible(false);lyr_Vandlb20mbuffer.setVisible(false);lyr_Vandlb10mbuffer.setVisible(false);lyr_Vandlb2mbuffer.setVisible(false);lyr_Vandlb.setVisible(false);lyr_Ser100mbuffer.setVisible(false);lyr_Ser20mbuffer.setVisible(false);lyr_Ser10mbuffer.setVisible(false);lyr_Ser2mbuffer.setVisible(false);lyr_Ser.setVisible(false);lyr_Jordforureningvidenniveau2V2.setVisible(false);lyr_Jordforureningvidenniveau1V1.setVisible(false);lyr_Frededeomrder.setVisible(false);lyr_EngeogMoser18701899.setVisible(false);lyr_Gammelkystlinje18701899.setVisible(false);lyr_Spildevandskloakeret.setVisible(true);lyr_Ingenkloakering.setVisible(true);lyr_Brndby.setVisible(true);
...
lyr_Ingenkloakering.set('fieldImages', {'fid': 'TextEdit', 'doklink': 'TextEdit', 'uuid': 'TextEdit', 'temakode': 'Range', 'temanavn': 'TextEdit', 'objekt_id': 'Range', 'systid_fra': 'TextEdit', 'oprettet': 'TextEdit', 'oprindkode': 'Range', 'oprindelse': 'TextEdit', 'statuskode': 'Range', 'status': 'TextEdit', 'cvr_kode': 'TextEdit', 'cvrname': 'TextEdit', 'bruger_id': 'TextEdit', 'link': 'TextEdit', 'navn1201': 'TextEdit', 'type1201a': 'Range', 'vaerd1201a': 'TextEdit', 'type1201b': 'Range', 'vaerd1201b': 'TextEdit', 'staar1201': 'Range', 'sluaar1201': 'Range', 'datoforsl': 'Range', 'datovedt': 'Range', 'datoaflyst': 'Range', 'datoikraft': 'Range', 'datostart': 'Range', 'datoslut': 'Range', 'CG_ID': 'Range', 'navn': 'TextEdit', 'regionskode': 'Range', 'udtraeksdato': 'DateTime', 'kommunekode': 'TextEdit', 'udenforkommuneinddeling': 'TextEdit', 'fid_2': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
lyr_Brndby.set('fieldImages', {'fid': 'TextEdit', 'navn': 'TextEdit', });
